...
pregunta1 = Pregunta_comun("Arte y Música", "preg comun prueba", "rta_correcta_original", "Normal", opciones_preg1)
daopreguntas.alta_preg_comun(pregunta1)
"""
"""
pregunta_aprox = Pregunta_aproximacion("Arte y Música", "preg de aprox de prueba", 100, "Dificil")
