...
class VistaJuego(MainWindow):  
    ...
    _listaIconos = ["8escalones\Images\playerIcon1.jpg",
                    "8escalones\Images\playerIcon2.jpg",
                    "8escalones\Images\playerIcon3.jpg",
                    "8escalones\Images\playerIcon4.jpg",
                    "8escalones\Images\playerIcon5.jpg",
                    "8escalones\Images\playerIcon6.jpg",
                    "8escalones\Images\playerIcon7.jpg",
                    "8escalones\Images\playerIcon8.jpg",
                    "8escalones\Images\playerIcon9.jpg"]
    
    def __init__(self,listaJugadores):
        super().__init__(config.get_image_path("FondoJuego.jpg"), 1000, 600)
        self._listaIconos = [
            config.get_image_path("playerIcon1.jpg"),
            config.get_image_path("playerIcon2.jpg"),
            config.get_image_path("playerIcon3.jpg"),
            config.get_image_path("playerIcon4.jpg"),
            config.get_image_path("playerIcon5.jpg"),
            config.get_image_path("playerIcon6.jpg"),
            config.get_image_path("playerIcon7.jpg"),
            config.get_image_path("playerIcon8.jpg"),
            config.get_image_path("playerIcon9.jpg"),
        ]
        self.setWindowIcon(QIcon(config.get_image_path("WindowIcon.png")))
